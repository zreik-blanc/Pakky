...
import { Package, Terminal, CheckCircle2, XCircle, Clock, Loader2, Check, AlertCircle, X, RotateCw, ChevronDown, ChevronUp } from "lucide-react"
                    ...
                    <div className="flex items-center gap-2 text-xs">
                        <Badge
                            ...
                            className={cn(
                                ...
                                pkg.type === 'cask' ? "text-primary/80" : "text-emerald-500/80"
                            )}
                        >
                            {pkg.type}
                        </Badge>
